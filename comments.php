...
<section id="respond" class="respond-form">
	...
	<h3 id="comment-form-title" class="h2"><?php comment_form_title( __('Leave a Reply', 'swedishfikatheme'), __('Leave a Reply to %s', 'swedishfikatheme' )); ?></h3>
	...
	<div class="alert info">
		<p id="allowed_tags" class="small"><strong>XHTML:</strong> <?php _e('You can use these tags', 'swedishfikatheme'); ?>: <code><?php echo allowed_tags(); ?></code></p>
	</div>
